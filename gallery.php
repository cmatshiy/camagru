...
include_once("fragments/functions/montage.php");
  ...
  <body>
    <?php include('fragments/header.php') ?>
      <div class="body">
        ...
        <div class="main">
    		  <div class="select">
      			<img class="thumbnail" src="img/heel.png"></img>
      			<input id="heel.png" type="radio" name="img" value="./img/heel.png" onclick="onCheckBoxChecked(this)">
      			<img class="thumbnail" src="img/bra.png"></img>
      			<input id="bra.png" type="radio" name="img" value="./img/bra.png" onclick="onCheckBoxChecked(this)">
          ...
          <div id="camera-camera">CAMERA-CAMERA</div>
          <img id="hat" style="display:none;" src="img/hat.png"></img>
          <img id="bra" style="display:none;" src="img/bra.png"></img>
          <img id="heel" style="display:none;" src="img/heel.png"></img>
